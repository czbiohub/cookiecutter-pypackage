...
- [Usage](#usage)
    ...
    - [3. Create the remote repository on GitHub and Push the newly created Python package to GitHub](#3-create-the-remote-repository-on-github-and-push-the-newly-created-python-package-to-github)
    - [4. Install your package!](#4-install-your-package)
    - [5. Check out the `hello` subcommand of your program!](#5-check-out-the-hello-subcommand-of-your-program)
    - [6. Check out the tests!](#6-check-out-the-tests)
    - [7. Add autogenerated documentation](#7-add-autogenerated-documentation)
    - [8. Release your package!](#8-release-your-package)
...
### 3. Create the remote repository on GitHub and Push the newly created Python package to GitHub

Go to [github.com]([https://github.com](https://github.com/czbiohub) ) and
click the plus sign ("+") to create a repository under the `czbiohub`
organization. Since via `cookiecutter` we already have a README and LICENSE, we
don't need those files. We'll want to check the box for Travis-CI integration
to run the tests for the code automatically.
...
![Example inputs for creating a repository](figures/create_repo.gif)
...
### 5. Check out the `hello` subcommand of your program!
...
### 7. Add autogenerated documentation
